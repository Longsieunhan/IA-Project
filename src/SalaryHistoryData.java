 ...
 */
public class SalaryHistoryData extends JFrame implements ActionListener
{
 ...
 private ArrayList<ArrayList<String>> dataList; // Stores raw data retrieved from the database
  ...
  public SalaryHistoryData(String dbName, String tableName, String[] tableHeaders)
  {
    super("Display Salary History");
